...
START_TEST(test_sub_matrix_valid) {
  ...
  A.matrix[0][0] = 5.0; A.matrix[0][1] = 6.0;
  A.matrix[1][0] = 7.0; A.matrix[1][1] = 8.0;
...
START_TEST(test_sub_matrix_zero_result) {
  ...
  A.matrix[0][0] = 5.0; A.matrix[0][1] = 5.0;
  A.matrix[1][0] = 5.0; A.matrix[1][1] = 5.0;
  
  B.matrix[0][0] = 5.0; B.matrix[0][1] = 5.0;
  B.matrix[1][0] = 5.0; B.matrix[1][1] = 5.0;
