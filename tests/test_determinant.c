...
START_TEST(test_determinant_zero) {
  ...
  A.matrix[0][0] = 1.0; A.matrix[0][1] = 2.0; A.matrix[0][2] = 3.0;
  A.matrix[1][0] = 2.0; A.matrix[1][1] = 4.0; A.matrix[1][2] = 6.0;
  A.matrix[2][0] = 3.0; A.matrix[2][1] = 6.0; A.matrix[2][2] = 9.0;
...
START_TEST(test_determinant_4x4) {
  ...
  A.matrix[0][0] = 1.0; A.matrix[0][1] = 0.0; A.matrix[0][2] = 0.0; A.matrix[0][3] = 0.0;
  A.matrix[1][0] = 0.0; A.matrix[1][1] = 2.0; A.matrix[1][2] = 0.0; A.matrix[1][3] = 0.0;
  A.matrix[2][0] = 0.0; A.matrix[2][1] = 0.0; A.matrix[2][2] = 3.0; A.matrix[2][3] = 0.0;
  A.matrix[3][0] = 0.0; A.matrix[3][1] = 0.0; A.matrix[3][2] = 0.0; A.matrix[3][3] = 4.0;
